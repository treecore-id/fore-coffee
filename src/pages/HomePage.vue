<template>
    <main>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 w-full justify-center items-center space-x-6 mx-auto md:max-w-lg lg:max-w-3xl 2xl:max-w-7xl">
                <div class="flex flex-col text-center md:text-left space-y-3">
                    ...
                    <h3 class="font-medium text-base md:text-2xl text-secondary">
                        Made with Indonesia’s Finest Beans for your everyday modern coffee
                        experience
                    </h3>
                </div>
        ...
        <section class="grid grid-cols-1 w-full justify-center items-center mx-auto mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 w-full justify-center items-center space-x-6 mx-auto md:max-w-lg lg:max-w-3xl 2xl:max-w-7xl">
                <figure class="block w-full">
                    <img src="/images/our-story-1.png" alt="Coffee Picture" class="object-contain object-center w-full h-full max-w-lg" />
                    <figcaption class="sr-only"></figcaption>
                </figure>
                <div class="block">
                    ...
                    <router-link to="#" class="group inline-flex items-center font-medium text-primary border-2 border-primary rounded-full px-6 py-2 mt-5 transition-all duration-100 ease-in hover:bg-primary hover:text-white">Read More
